...
public final class PieceWorker extends Employee {
    ...
    public PieceWorker(String first, String last,int year,int monthOfYear, int dayOfMonth, int hourOfDay, int minuteOfHour,
            double wage, int numberOfItems) throws InvalidDateException {
